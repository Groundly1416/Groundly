        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm leading-relaxed">
              Outdoor private spaces, curated for photographers, ad agencies, and creative pros.
            </p>
          </div>
          <div>
            ...
            <div className="space-y-2">
              ...
              <Link href="/creative-network" className="block text-sm hover:text-white transition-colors">Creative Network</Link>
            </div>
          </div>
          <div>
            <h4 className="text-white font-medium text-sm mb-3">Hosting</h4>
            <div className="space-y-2">
              <Link href="/signup" className="block text-sm hover:text-white transition-colors">List Your Space</Link>
            </div>
          </div>
          <div>
