...
const FAQS = [
  ...
  { q: 'What types of bookings are allowed?', a: 'Groundly supports a wide range of outdoor bookings including photoshoots, engagement sessions, brand shoots, retreats, and more. Hosts set their own rules about what types of bookings they allow and how many guests are permitted, so every booking is on your terms.' },
  ...
  { q: 'Does Groundly provide insurance for hosts?', a: 'No. Groundly is a marketplace that connects property owners with guests. Groundly does not provide insurance coverage for hosts, guests, or any activities that take place on a host\'s property. Hosts are responsible for maintaining their own insurance coverage. We recommend consulting with your insurance provider to understand your options. For affordable, same-day event insurance, providers like Thimble (thimble.com) and Markel (markel.com) offer policies starting as low as $75 that can be purchased up to one day before your event.' },
  ...
  { q: 'Do guests or creative professionals need insurance?', a: 'We recommend that photographers, ad agencies, and production teams carry their own liability insurance, which is standard practice in the industry. For casual bookings like portrait sessions or family photos, guest insurance is not required but is always advisable.' },
