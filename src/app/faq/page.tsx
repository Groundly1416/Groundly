...
const FAQS = [
  ...
  { q: 'What types of bookings are allowed?', a: 'Groundly is built for creative professional bookings — photoshoots, content sessions, brand shoots, editorial productions, commercial ad shoots, and more. Hosts approve every booking and can decline any request that doesn\'t fit. Multi-hundred-person events, weddings, and parties are not supported on the platform.' },
