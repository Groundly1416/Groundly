...
const sidebarLinks = [
  { href: '/dashboard/guest', label: 'My Bookings', icon: Calendar },
  { href: '/dashboard/guest/favorites', label: 'Favorites', icon: Heart },
  { href: '/dashboard/guest/settings', label: 'Settings', icon: Settings },
];
        ...
        <div className="flex gap-8">
          ...
          <aside className="hidden lg:block w-56 shrink-0">
            <div className="sticky top-24 space-y-1">
              <p className="px-3 mb-3 text-xs font-medium text-stone-400 uppercase tracking-wider">My Account</p>
              {sidebarLinks.map(link => {
                const Icon = link.icon;
                const active = link.href === '/dashboard/guest'
